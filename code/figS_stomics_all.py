#!/usr/bin/env python3
"""Spatial validation: all 8 samples — HB comm genes on STOMICS"""
...
fig.suptitle("STOMICS Spatial: Hofbauer Cell Communication Genes — All Samples",
             fontsize=16, fontweight='bold', y=0.995)
fig.tight_layout()
fig.savefig(OUT / "FigS_stomics_all.png", dpi=300, bbox_inches='tight')
plt.close()
print(f"Done: {OUT / 'FigS_stomics_all.png'}")
