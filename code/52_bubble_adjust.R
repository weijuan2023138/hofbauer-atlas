...
png("figures/Fig4/Fig4_cellchat_bubble_incoming.png", w=6, h=7, units="in", res=300)
...
png("figures/Fig4/Fig4_cellchat_bubble_outgoing.png", w=5, h=7, units="in", res=300)
netVisual_bubble(cellchat,
  sources.use="HB",
